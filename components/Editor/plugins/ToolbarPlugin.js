...
function BlockOptionsDropdownList({
  ...
  function formatCheckList() {
    if (blockType !== "checklist") {
      ...
      editor.dispatchCommand(REMOVE_CHECK_LIST_COMMAND);
    }
    setShowBlockOptionsDropDown(false);
  }
  ...
  return (
    <div className="dropdown" ref={dropDownRef}>
      <button className="item" onClick={formatLargeHeading}>
        <span className="icon editor-heading-h1" />
        <span className="text">Heading 1</span>
        {blockType === "h1" && <span className="active" />}
      </button>
      <button className="item" onClick={formatSmallHeading}>
        <span className="icon editor-heading-h2" />
        <span className="text">Heading 2</span>
        {blockType === "h2" && <span className="active" />}
      </button>
      <button className="item" onClick={formatSmallHeading}>
        <span className="icon editor-heading-h3" />
        <span className="text">Heading 3</span>
        {blockType === "h3" && <span className="active" />}
      </button>
      <button className="item" onClick={formatSmallHeading}>
        <span className="icon editor-heading-h4" />
        <span className="text">Heading 4</span>
        {blockType === "h4" && <span className="active" />}
      </button>
      <button className="item" onClick={formatSmallHeading}>
        <span className="icon editor-heading-h5" />
      ...
      <button className="item" onClick={formatCheckList}>
        ...
        {blockType === "checklist" && <span className="active" />}
      </button>
    ...
    if ($isRangeSelection(selection)) {
      ...
      if (elementDOM !== null) {
        ...
        if ($isListNode(element)) {
          ...
          setBlockType(type);
        } else if ($isCheckListNode(element)) {
