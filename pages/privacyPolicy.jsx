...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <Navbar />
      <main className="mx-auto max-w-5xl py-4 mt-20">
        <h1 className="text-4xl font-bold mb-4">Privacy Policy</h1>
          <p className="mb-4">Last updated: December 08, 2023</p>
        ...
        <h2 className="text-3xl font-bold mb-4">Interpretation and Definitions</h2>
        ...
        <h3 className="text-2xl font-bold mb-4">Definitions</h3>
          ...
          <ul className="list-disc list-inside indent-8">
            ...
            <li className="mb-4">
              <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Pocket Journal.
            </li>
            <li className="mb-4">
            ...
            <li className="mb-4">
              <strong>Website</strong> refers to Pocket Journal, accessible from <a href="https://pocket-journal.app" rel="external nofollow noopener" target="_blank">https://pocket-journal.app</a>
            </li>
            <li className="mb-4">
              <strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
            </li>
          </ul>
        <h2 className="text-3xl font-bold mb-4">Collecting and Using Your Personal Data</h2>
        ...
        <h4 className="text-xl font-bold mb-4">Information from Third-Party Social Media Services</h4>
          ...
          <ul className="list-disc list-inside indent-8 mb-4">
        ...
        <h4 className="text-xl font-bold mb-4">Tracking Technologies and Cookies</h4>
        ...
        <h3 className="text-2xl font-bold mb-4">Retention of Your Personal Data</h3>
        ...
        <h3 className="text-2xl font-bold mb-4">Transfer of Your Personal Data</h3>
        ...
        <h3 className="text-2xl font-bold mb-4">Disclosure of Your Personal Data</h3>
        ...
        <h3 className="text-2xl font-bold mb-4">Security of Your Personal Data</h3>
        ...
        <h2 className="text-3xl font-bold mb-4">Contact Us</h2>
          ...
          <ul className="list-disc list-inside indent-8">
            <li className="mb-4">By email: creepylight1030@gmail.com</li>
          </ul>
      </main>
