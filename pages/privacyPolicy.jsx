      ...
      <main className="mx-auto max-w-5xl py-4">
        ...
        <h3 className="text-2xl font-bold">Definitions</h3>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Pocket Journal.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to Pocket Journal, accessible from <a href="https://pocket-journal.app" rel="external nofollow noopener" target="_blank">https://pocket-journal.app</a></p>
            </li>
            <li>
              <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
            </li>
          </ul>
        <h2 className="text-3xl font-bold">Collecting and Using Your Personal Data</h2>
        ...
        <h4 className="text-xl font-bold">Information from Third-Party Social Media Services</h4>
        ...
        <h2 className="text-3xl font-bold">Contact Us</h2>
          ...
          <ul>
            <li>By email: creepylight1030@gmail.com</li>
          </ul>
      </main>
      <Footer />
    </>
